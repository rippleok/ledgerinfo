...
[
     {
        ...
        gateways: 
        [
           {name: 'bitstamp', address: 'rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B',price:{value:0,action:'asks'},volume:{xrp:0,iou:0},url:''},
           {name: 'snapswap', address: 'rMwjYedjc7qqtKYVLiAccJSmCwih4LnE2q',price:{value:0,action:'asks'},volume:{xrp:0,iou:0},url:''}
        ]
     },

     {
        ...
        gateways: 
        [
           {name: 'ripplechina', address: 'razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA',price:{value:0,action:'asks'},volume:{xrp:0,iou:0},url:''},
           {name: 'ripplecn', address: 'rnuF96W4SZoCJmbHYBFoJZpR8eCaxNvekK',price:{value:0,action:'asks'},volume:{xrp:0,iou:0},url:''},
					 {name: 'ripplefox', address: 'rKiCet8SdvWxPXnAgYarFUXMh1zCPz432Y',price:{value:0,action:'asks'},volume:{xrp:0,iou:0},url:''}
        ]        
     },
		 {
        name: 'KoreaWon',
        ...
        [
           {name: 'SnapSwap', address: 'rMwjYedjc7qqtKYVLiAccJSmCwih4LnE2q',price:{value:0,action:'asks'},volume:{xrp:0,iou:0},url:''},
           {name: 'therock', address: 'rLEsXccBGNR3UPuPu2hUXPjziKC3qKSBun',price:{value:0,action:'asks'},volume:{xrp:0,iou:0},url:''}
        ]        
     },
		 {
        name: 'JapanYen',
     ...
     },
     {
        ...
        [
           {name: 'bitstamp', address: 'rvYAfWj5gh67oV6fW32ZzP3Aw4Eubs59B',price:{value:0,action:'asks'},volume:{xrp:0,iou:0},url:''},
					 {name: 'btc2ripple', address: 'rMwjYedjc7qqtKYVLiAccJSmCwih4LnE2q',price:{value:0,action:'asks'},volume:{xrp:0,iou:0},url:''}
        ]                
     },
		 {
