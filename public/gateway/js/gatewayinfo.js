...
function booksubscribe(){
	...
	asksbook=remote.book(goods.currency, goods.issuer, money.currency, money.issuer);
	bidsbook=remote.book(money.currency, money.issuer, goods.currency, goods.issuer);
